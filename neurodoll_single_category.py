...
if __name__ == "__main__":
    ...
    if(do_category):
        ...
        for index_to_show in range(0,21):
            ...
            t1 = cv2.threshold(result,60,255,cv2.THRESH_BINARY)
            t2 = cv2.threshold(result,127,255,cv2.THRESH_BINARY)
            t3 = cv2.threshold(result,180,255,cv2.THRESH_BINARY)
            ...
            outmat[256*2:256*3,256*index_to_show:256*(index_to_show+1)] = t5
