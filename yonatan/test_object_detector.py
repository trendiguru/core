...
def theDetector(url_or_np_array):
    ...
    print cv2.imwrite("/data/yonatan/linked_to_web/dress_detector_result_045_" + str(url_or_np_array) + ".jpg", padded_image)
    ...
    print cv2.imwrite("/data/yonatan/linked_to_web/dress_detector_result_07_" + str(url_or_np_array) + ".jpg", padded_image2)
