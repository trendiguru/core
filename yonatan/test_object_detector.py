...
def detect(url_or_np_array, label=0):
    ...
    if dets:
        print cv2.imwrite("/data/yonatan/linked_to_web/svm_C_20/dress_detector_result_045_" + str(label) + ".jpg", padded_image)
    ...
    if dets2:
        print cv2.imwrite("/data/yonatan/linked_to_web/svm_C_20/dress_detector_result_07_" + str(label) + ".jpg", padded_image2)
