...
paperdoll_whole_body = ['bodysuit', 'dress', 'jumper', 'suit', 'romper']
paperdoll_upper_cover = ['blazer', 'cape', 'jacket', 'cardigan', 'coat', 'vest', 'sweatshirt']
paperdoll_upper_under = ['t-shirt', 'blouse', 'shirt', 'top', 'sweater', 'sweatshirt']
