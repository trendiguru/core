...
pd_worker_command_braini1 =  'cd /home/pd_user/paperdoll/paperdoll-v1.0/ && python rqworker -w trendi.matlab_wrapper.tgworker.TgWorker -u redis://redis1-redis-1-vm:6379 pd &'
