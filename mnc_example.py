...
def get_mnc_output_using_falcon(url):
    ...
    result_mask = mnc_output["mask"]
    result_box = mnc_output["box"]
    ...
    cv2.putText(orig_im,'human:'+str(confidence),org=(pt1[0],pt1[1]-10),fontFace=cv2.FONT_HERSHEY_PLAIN,fontScale=2)
