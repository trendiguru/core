...
if __name__ == '__main__':
    ...
    n,singles,multiples = ccv.run_classifier_recursively('images/many_faces',use_visual_output=False,classifier=find_face,**kwargs={'method':'ccv'})
    print('n:{0} single:{1} multiple:{2}'.format(n,singles,multiples))
    raw_input('enter to continue')

    #defulat is ccv
    n,singles,multiples = ccv.run_classifier_recursively('images/many_faces',use_visual_output=False,classifier=find_face,**kwargs={'method':'cascade'})
    print('n:{0} single:{1} multiple:{2}'.format(n,singles,multiples))
    raw_input('enter to continue')
