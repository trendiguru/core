...
def show_mask_with_labels_dir(dir,labels,filter=None,original_images_dir=None,original_images_dir_alt=None):
    '''
...
#        cv2.putText(colorbar,labels[unique],(5,i*bar_height+bar_height/2-10),cv2.FONT_HERSHEY_PLAIN,1,[i*255/len(uniques),i*255/len(uniques),100],thickness=2)
    ...
    if original_image is not None:
        ...
        if orig_arr is not None:
            ...
            print('colobar size {} masksize {} imsize {}'.format(dest_colorbar.shape,dest,orig_arr))
