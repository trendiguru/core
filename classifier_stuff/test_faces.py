...
def check_dir(dir):
    print('doing dir {}'.format(subdir))
    files = [os.path.join(subdir,f) for f in os.listdir(subdir) if not os.path.isdir(os.path.join(subdir,f))]
...
if __name__ == "__main__":
    dir = '/media/jeremy/9FBD-1B00/data/jeremy/image_dbs/mongo/amazon_us_female'
